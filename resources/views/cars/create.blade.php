...
@section('content')
    ...
    <form action={{route("cars.store")}} method="post">
        ...
        <div>
            ...
            <input type="text" id="serie" name="serie" required value="{{old("serie")}}" >
            @error("serie")
            <span>{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="number" step="0.01" id="price" required value="{{old("price")}}" name="price" >
            @error("price")
            <span>{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="number" step="1" id="power" name="power" required value="{{old("power")}}" >
            @error("power")
            <span>{{ $message }}</span>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="url" id="thumbnail" name="thumbnail" value="{{old("thumbnail")}}" required>
            @error("thumbnail")
            <span>{{ $message }}</span>
            @enderror
        </div>
